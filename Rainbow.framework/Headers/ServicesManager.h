...
FOUNDATION_EXPORT NSString *const kServicesManagerNetworkConnectionDetected;
 ...
 */
@property (nonatomic, readonly) BOOL isNetworkDisconnected;
...
/**
 *  Conversations search helper
 *  @see ConversationsSearchHelper
 */
@property (readonly) ConversationsSearchHelper *conversationsSearchHelper;
...
@property (readonly) LocationService *locationService;
 ...
 * Favorites manager
 */
@property (readonly) FavoritesManager *favoritesManager;
