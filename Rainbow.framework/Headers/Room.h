...
/**
 *  @return `YES` if this room is active
 */
...
/**
 *  Return Check if room is a WebRTC conference
 */
-(BOOL) isWebRTCConferenceRoom;

/**
 *  Return Check if room is a PGi conference
 */
-(BOOL) isPGIConferenceRoom;

/**
 *  Return the number of accepted participants
 */
-(int) authorizedParticipantsCount;
