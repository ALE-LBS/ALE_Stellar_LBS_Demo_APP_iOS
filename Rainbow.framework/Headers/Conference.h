...
/**
 *  The different conference media type
 */
typedef NS_ENUM(NSInteger, ConferenceMediaType) {
    ConferenceMediaTypeUnknown = 0,
    /**
     *  Conference media type PSTN
     */
    ConferenceMediaTypePSTN,
    /**
     *  Conference media type WebRTC
     */
    ConferenceMediaTypeWebRTC
};

@interface Conference : NSObject
@property (nonatomic, readonly) ConferenceType type;
@property (nonatomic, readonly) ConferenceMediaType mediaType;
