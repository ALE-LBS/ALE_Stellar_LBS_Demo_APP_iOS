...
/**
 * rainbow id of the file
 */
@property (readonly) NSString *rainbowID;
/**
 * file url on server
 */
...
/**
 *  Temporarly, use of this list instead of viewers because the channel cannot be a Peer
 */
@property (readonly) NSArray *viewersChannels;
...
/**
 *  @return `YES` if the file has a location info
 */
@property (readonly) BOOL isLocationFile;
@end
